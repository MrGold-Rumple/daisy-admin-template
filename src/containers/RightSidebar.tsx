...
function RightSidebar(){
    ...
    return(
        <div className={" fixed overflow-hidden z-20 bg-base-300/50 inset-0 transform ease-in-out " + (isOpen ? " transition-opacity opacity-100 duration-500 translate-x-0  " : " transition-all delay-500 opacity-0 translate-x-full  ")}>
                            ...
                            {
                                {
                                        ...
                                        [RIGHT_DRAWER_TYPES.CALENDAR_EVENTS] : <CalendarEventsBodyRightDrawer filteredEvents={extraObject?.filteredEvents as { title: string; theme: string }[] || []} closeRightDrawer={close}/>,
                                        [""] : <div></div>,
                                }[bodyType] || <div></div>
                            }
